                ...
                <div class="gantt-zero-roadmap">
                    ...
                    <div class="gantt-zero-roadmap-chart" style="position: relative;">
                        <div
                            ...
                            data-cell-id="main" style="width: 434px; height: 222px; padding: 0px;">
                            <div
                                class="gantt_layout_cell gantt_layout gantt_layout_x  gantt_layout_cell_border_transparent gantt_layout_cell_border_bottom"
                                data-cell-id="c1726637708793"
                                style="margin-bottom: 0px; width: 432px; height: 203px; padding: 0px;">
                                <div
                                    ...
                                    data-cell-id="1726637708794" style="margin-right: 0px; width: 70px; height: 202px;">
                                ...
                                <div
                                    ...
                                    data-cell-id="1726637708795"
                                    style="margin-right: 0px; width: 345px; height: 202px;">
                                    <div class="gantt_layout_content" style="height: 202px;">
                                ...
                                <div class="gantt_layout_cell  scrollVer_cell" data-cell-id="1726637708796"
                            ...
                            <div class="gantt_layout_cell  scrollHor_cell" data-cell-id="1726637708797"
                                 style="width: 432px; height: 17px;">
                                <div class="gantt_layout_content" style="height: 17px;">
                                    <div class="gantt_layout_cell gantt_hor_scroll"
                                         style="width: 416px; height: 17px; top: auto;">
        ...
        <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="position-relative mb-sm-4 mb-xl-0">
                            <div class="echart-issue-chart"
                                 ...
                                 _echarts_instance_="ec_1726637708415">
                                <div
                                    style="position: relative; width: 248px; height: 390px; padding: 0px; margin: 0px; border-width: 0px;">
                                    <canvas data-zr-dom-id="zr_0" width="248" height="390"
                                            style="position: absolute; left: 0px; top: 0px; width: 248px; height: 390px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                                </div>
                                <div class=""></div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-xl-5 col-xxl-6">
                ...
                <div class="echart-zero-burnout-chart"
                     ...
                     _echarts_instance_="ec_1726637708414">
                    <div
                        style="position: relative; width: 356px; height: 320px; padding: 0px; margin: 0px; border-width: 0px;">
                        <canvas data-zr-dom-id="zr_0" width="356" height="320"
                                style="position: absolute; left: 0px; top: 0px; width: 356px; height: 320px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                    </div>
                    <div class=""></div>
                </div>
            </div>
                                                        ...
                                                        <div class="choices" data-type="select-multiple" role="combobox"
                                                            ...
                                                            <div class="choices__list choices__list--dropdown"
                                                                ...
                                                                <div class="choices__list" aria-multiselectable="true"
                                                                     role="listbox">
                                                                    <div id="choices--0xvk-item-choice-1"
                                                                    ...
                                                                    <div id="choices--0xvk-item-choice-2"
                                                                    ...
                                                                    <div id="choices--0xvk-item-choice-3"
                                                                         class="choices__item choices__item--choice choices__item--selectable"
                                                                    ...
                                                                    <div id="choices--0xvk-item-choice-5"
                                                                         class="choices__item choices__item--choice choices__item--selectable"
