    ...
    <div class="row g-4">
        <div class="col-12 col-xxl-6">
            <div class="mb-8">
                ...
                <h5 class="text-body-tertiary fw-semibold">{{ $site->factory->title . ' - ' . $site->factory->address }}
                </h5>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            const fetchDataAndUpdateChart = async (timeframe) => {
                const data = await fetchData(`site/${site.id}/aggregate-sensor-data?timerange=${timeframe}`);
