    ...
    <div class="row g-4">
        <div class="col-12 col-xxl-6">
            <div class="mb-8">
                ...
                <h5 class="text-body-tertiary fw-semibold">See what's going on your business.</h5>
            </div>
        </div>
    </div>
    ...
    <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-body-emphasis pt-7 pb-3 border-y">
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div id="factoriesPowerChart" style="width: 100%; height: 400px;"></div>
            </div>
            <div class="col-12 col-md-6">
                <div class="d-flex align-items-center justify-content-between">
                    <h3>Energy Consumption Over Time</h3>
                </div>
                <div id="factoriesEnergyChart" style="width: 100%; height: 400px;"></div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        ...
        const x = data.map(entry => entry.title)
        const power = data.map(entry => entry.power)
        const energy = data.map(entry => entry.energy);

        barChart('#factoriesPowerChart', x, [barSeries(power, 'Power')])
        barChart('#factoriesEnergyChart', x, [barSeries(energy, 'Energy')])
    </script>
@endpush
