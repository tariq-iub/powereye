            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Search files"
                               aria-label="Search"/>
        ...
        <table class="table table-sm fs-9 mb-0">
            ...
            <tbody class="list" id="files-table-body">
                @foreach ($files as $file)
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="factory align-middle white-space-nowrap">
                            <h6 class="mb-0 ms-3 fw-semibold">{{ $file->id }}</h6>
                        </td>
                        <td class="customer align-middle white-space-nowrap">
                            <a class="d-flex align-items-center text-body text-hover-1000 ps-2" href="#">
                                <h6 class="mb-0 ms-3 fw-semibold">{{ $file->file_name }}</h6>
                            </a>
                        </td>
                        <td class="factory align-middle white-space-nowrap">
                            <h6 class="mb-0 ms-3 fw-semibold">{{ $file->device->serial_number }}</h6>
                        </td>
                        <td class="email align-middle white-space-nowrap">
                            <h6 class="mb-0 ms-3 fw-semibold">{{ $file->site->title }}</h6>
                        </td>
                        <td class="email align-middle white-space-nowrap">
                            <h6 class="mb-0 ms-3 fw-semibold">{{ $file->site->factory->title }}</h6>
                        </td>
                        <td class="email align-middle white-space-nowrap">
                            <h6 class="mb-0 ms-3 fw-semibold">{{ $file->file_path }}</h6>
                        </td>
                        <td class="actions align-middle text-end white-space-nowrap text-body-tertiary">
                            <div class="btn-reveal-trigger position-static">
                                <button
